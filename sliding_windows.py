...
def fit_polynomial(binary_warped,tracking):
    ...
    def radius_of_curvature(binary_warped,window_centroids):
        ...
        print(left_curverad, 'm', tracking.right_line.cal_curvature(right_curverad), 'm')
    ...
    def convolve(binary_warped,last_window_centroids=None):
        ...
        if last_window_centroids is not None :
            ...
            bottom_image = binary_warped[int(binary_warped.shape[0]*(3/4)):]
        ...
        for level in range(1,(int)(binary_warped.shape[0]/window_height)):
            ...
            image_layer = binary_warped[int(binary_warped.shape[0]-(level+1)*window_height):int(binary_warped.shape[0]-level*window_height),:]
